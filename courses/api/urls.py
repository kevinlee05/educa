...
router.register('courses', views.CourseViewSet) #register courseviewset with courses prefix
...
urlpatterns = [
        ...
        url(r'^', include(router.urls)), #router generates URLs automatically for viewset
    ]